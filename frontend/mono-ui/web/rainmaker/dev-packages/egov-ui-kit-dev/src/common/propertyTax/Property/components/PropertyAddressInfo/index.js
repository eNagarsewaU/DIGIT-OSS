    ...
    return (
      address && [
...

        {
          ...
          value: getTranslatedLabel("TENANT_TENANTS_UK_" + address.city.toUpperCase(), localizationLabelsData) || "NA",
        },
        {
        ...
        },
        {
          ...
          value: getTranslatedLabel((tenantId.replace(".", "_") + "_REVENUE_" + address.locality.code).toUpperCase(), localizationLabelsData) || "NA",
        },
        {
        ...
        },
        {
          ...
          value:
            (additionalDetails &&
              ...
              getTranslatedLabel(("PROPERTYTAX_ROADTYPE_" + additionalDetails.roadType).toUpperCase(), localizationLabelsData)) ||
            "NA",
        },
        {
          ...
          value:
            (additionalDetails &&
              ...
              getTranslatedLabel(
                "PROPERTYTAX_THANA_" + tenantId.replace(".", "_").toUpperCase() + "_" + additionalDetails.thana.toUpperCase(),
